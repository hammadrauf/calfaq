 ...
 *
 *   The implementation follows the formulas mentioned in the FAQ
 *   quite closely. The focus of the implementation is on simplicity
 *   and clarity. For this reason, no complex data structures or
 *   classes are used, nor has any attempt been made to optimize the
 *   code. Also, no verification of the input parameters is performed
 *   (except in the function simple_gregorian_easter).
 *
 *   All numbers (including Julian Day Numbers which currently have
...
int epact(int style, int year)
{
    if (style==JULIAN) {
        ...
        int c = year/100;
        int solar_eq = (3*(c+1))/4;
        int lunar_eq = (8*c + 13)/25;
